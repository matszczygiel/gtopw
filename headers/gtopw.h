...
inline void PrintCMatrix( const cdouble* m, const int n ) {
    ...
    for(int i=0; i<n; i++) {
        for(int j=0; j<n; j++) std::cout << std::setw(25) << real( m[i*n+j] ) << " ";
        std::cout << std::endl;
    };
    std::cout << std::endl;
    std::cout << " Imag component:" << std::endl;
    for(int i=0; i<n; i++) {
        for(int j=0; j<n; j++) std::cout << std::setw(25) << imag( m[i*n+j] ) << " ";
        std::cout << std::endl;
    };
...
inline void PrintCMatrixRect( const cdouble* m, const int k, const int n ) {
    ...
    std::cout << std::showpos;
    for(int i=0; i<k; i++) {
        for(int j=0; j<n; j++) std::cout << std::setw(25) << real( m[i*k+j] ) << " ";
        std::cout << std::endl;
    };
    std::cout << std::endl;
    std::cout << " Imag component:" << std::endl;
    for(int i=0; i<k; i++) {
        for(int j=0; j<n; j++) std::cout << std::setw(25) << imag( m[i*k+j] ) << " ";
        std::cout << std::endl;
    };
    std::cout << std::noshowpos;
    /* */
...
inline void PrintMatrix( const double** m, const int n ) {
    ...
    std::cout << std::showpos;
    for(int i=0; i<n; i++) {
        for(int j=0; j<n; j++) std::cout << std::setw(25) << m[i][j] << " ";
        std::cout << std::endl;
    };
    std::cout << std::noshowpos;
};
...
inline void PrintMatrixPacked( const double* m, const int n ) {
    ...
    std::cout << std::showpos;
    for(int i=0; i<n; i++) {
        for(int j=0; j<n; j++) std::cout << std::setw(25) << m[i*n+j] << " ";
        std::cout << std::endl;
    };
    std::cout << std::noshowpos;
};
...
template <typename T> class arr1d {
    public:
    int num;
    T* v;
    ...
    arr1d( const int num_ ) : num(num_) { 
        v = new T[num]; std::memset(v,0,num*sizeof(T));
    };
   ~arr1d() { delete []v; };
    void zero() { std::memset(v,0,num*sizeof(T)); };
};

template <typename T> class arr2d {
    public:
    int num_x;
    int num_y;
    ...
    arr2d( const int num_x_, const int num_y_ ) : 
        num_x( num_x_ ), num_y( num_y_ ) { 
        v = new T*[num_x]; 
   ...
   ~arr2d() {
       for(int i=0; i<num_x; i++) delete []v[i];
       delete []v;
    };
